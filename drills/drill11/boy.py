...
# Boy Event
RIGHT_DOWN, LEFT_DOWN, RIGHT_UP, LEFT_UP, SLEEP_TIMER, SPACE , LSHIFT_DOWN, RS0HIFT_DOWN, LSHIFT_UP, RSHIFT_UP, SHIFT_TIMER= range(11)
...
next_state_table = {
    IdleState: {RIGHT_UP: RunState, LEFT_UP: RunState, RIGHT_DOWN: RunState, LEFT_DOWN: RunState, SLEEP_TIMER: SleepState,
                SPACE: IdleState, LSHIFT_DOWN: IdleState, RSHIFT_DOWN: IdleState, LSHIFT_UP: IdleState, RSHIFT_UP: IdleState },
    RunState: {RIGHT_UP: IdleState, LEFT_UP: IdleState, LEFT_DOWN: IdleState, RIGHT_DOWN: IdleState,
               SPACE: RunState, LSHIFT_DOWN: DashState, RSHIFT_DOWN : DashState, LSHIFT_UP: RunState, RSHIFT_UP: RunState },
    SleepState: {LEFT_DOWN: RunState, RIGHT_DOWN: RunState, LEFT_UP: RunState, RIGHT_UP: RunState, SPACE: IdleState, RSHIFT_DOWN: SleepState, LSHIFT_DOWN: SleepState,
    ...
    DashState: {RIGHT_UP: IdleState, LEFT_UP: IdleState, LEFT_DOWN: IdleState, RIGHT_DOWN: IdleState,
               SPACE: RunState, LSHIFT_DOWN: DashState, RSHIFT_DOWN : DashState, LSHIFT_UP: RunState, RSHIFT_UP: RunState, SHIFT_TIMER: RunState }
}
