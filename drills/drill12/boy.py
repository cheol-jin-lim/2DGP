...
class SleepState:
    ...
    def do(boy):
        boy.frame = (boy.frame + FRAMES_PER_ACTION * ACTION_PER_TIME * game_framework.frame_time) % 8
        boy.degree += 720 * game_framework.frame_time
    ...
    def draw(boy):
        ...
        boy.image.clip_draw(int(boy.frame) * 100, 300, 100, 100,boy.r_x + 100 * math.cos(2 * math.pi * boy.degree / 360),boy.r_y + 100 * math.sin(2 * math.pi * boy.degree / 360))
...
class Boy:
    ...
    def __init__(self):
        ...
        self.degree = 0
        self.alpha = random.randrange(1, 80) % 0.8
        self.r_x = 800
        self.r_y = 300
