...
class Death_blue_enemy_stage1:
    ...
    def update(self):
        if self.dead_enemy == True:
            self.total_frame += 15 * Death_blue_enemy_stage1.FRAMES_PER_ACTION * Death_blue_enemy_stage1.ACTION_PER_TIME * game_framework.frame_time
